...
from rag.config import DEFAULT_LAW_DOC_PATH, DEFAULT_VERDICT_OUTPUT_DIR
...
def process_case(
    ...
    try:
        parsed, usage = generate_structured_output(
            ...
            output_model=VerdictOnlyOutput,
        )
...
def main() -> None:
    ...
    parser.add_argument("--law-doc", default=DEFAULT_LAW_DOC_PATH, help="Path to law_doc.json")
    parser.add_argument(
        "--output-dir",
        default=DEFAULT_VERDICT_OUTPUT_DIR,
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "aistudio=gemma-4-31b-it, openrouter=google/gemma-4-31b-it, "
            "openai=gpt-5.4-nano"
        ),
    )
